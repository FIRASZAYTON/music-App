...
import 'package:ui_screen_project/feature/view/screen/favorite_screen.dart';
...
class MusicScreen extends StatefulWidget {
  ...
  int index;
  MusicScreen({required this.songs, required this.index});
                  ...
                  child: Row(
                    ...
                    children: [
                      ContainerShadow(
                        child: IconButton(
                            onPressed: () async {
                              // context.read<ViewModel>().getSongsFavorite();
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
